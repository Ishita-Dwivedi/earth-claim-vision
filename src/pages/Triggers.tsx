    ...
    <div className="space-y-6 pb-20 md:pb-8">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card className="p-6 bg-gradient-to-br from-success/5 to-success/10 border-success/20">
          ...
          <p className="text-2xl font-bold">{parametricTriggers.filter(t => t.triggered).length}</p>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-semibold text-lg">
                    {trigger.current_value} {trigger.parameter.includes("km/h") ? "km/h" : trigger.parameter.includes("mm") ? "mm" : "m"}
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <span className="font-medium">
                    {trigger.threshold} {trigger.parameter.includes("km/h") ? "km/h" : trigger.parameter.includes("mm") ? "mm" : "m"}
                  </span>
                </div>
